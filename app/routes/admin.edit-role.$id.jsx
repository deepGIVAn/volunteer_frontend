...
export async function loader({ request, params }) {
	...
	try {
		let response = await fetch(`${import.meta.env.VITE_API_URL}/admin/get-role/${id}`, {
				method: 'GET',
				headers: {
		...
		return redirect(RoutesPath.adminRoles);
	}
